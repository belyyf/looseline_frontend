...
-- Ставки
INSERT INTO bets (bet_id, user_id, event_id, odds_id, bet_type, bet_amount, coefficient, potential_win, status, result, actual_win, placed_at, event_name, event_end_date, expected_result) VALUES
    (1, 'user_123', 1, 1, '1', 100.00, 1.85, 185.00, 'resolved', 'win', 185.00, '2025-12-15 10:30:00', 'Man Utd vs Liverpool', '2025-12-15 20:00:00', 'П1'),
    (2, 'user_123', 2, 4, '1', 50.00, 2.10, 105.00, 'resolved', 'win', 105.00, '2025-12-15 11:00:00', 'Real Madrid vs Barcelona', '2025-12-15 21:45:00', 'П1'),
    (3, 'user_456', 1, 2, 'X', 200.00, 3.40, 680.00, 'resolved', 'loss', 0.00, '2025-12-15 10:45:00', 'Man Utd vs Liverpool', '2025-12-15 20:00:00', 'X'),
    (4, 'user_789', 3, 7, '1', 1000.00, 1.75, 1750.00, 'open', NULL, NULL, '2025-12-16 12:00:00', 'Arsenal vs Chelsea', '2025-12-16 22:00:00', 'П1'),
    (5, 'user_123', 3, 8, 'X', 150.00, 3.50, 525.00, 'open', NULL, NULL, '2025-12-16 13:00:00', 'Arsenal vs Chelsea', '2025-12-16 22:00:00', 'X'),
    (6, 'user_456', 4, 10, '1', 75.00, 1.90, 142.50, 'open', NULL, NULL, '2025-12-17 09:00:00', 'PSG vs Marseille', '2025-12-17 23:00:00', 'П1')
