---
order: 0.8
title: Модуль ставок и расчётов
---
...
![](./modul-stavok-i-raschetov.png){width=1565px height=672px}

**Скрин 1 -- Страница размещения ставок (список событий + купон)**

![](./modul-stavok-i-raschetov-2.png){width=1695px height=605px}

**Скрин 2 -- Заполненный купон с расчётом потенциального выигрыша**

![](./modul-stavok-i-raschetov-3.png){width=777px height=490px}
...
![](./modul-stavok-i-raschetov-4.png){width=760px height=251px}
...
![](./modul-stavok-i-raschetov-6.png){width=1863px height=894px}



Всё работает с бэкендом

![](./modul-stavok-i-raschetov-5.png){width=808px height=600px}